...
CMakeFiles/zookeeper-complete: ../deps/zookeeper/src/zookeeper-stamp/zookeeper-install
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/root/PowerGraph/debug/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Completed 'zookeeper'"
	/usr/local/bin/cmake -E make_directory /root/PowerGraph/debug/CMakeFiles
	/usr/local/bin/cmake -E touch /root/PowerGraph/debug/CMakeFiles/zookeeper-complete
...
../deps/zookeeper/src/zookeeper-stamp/zookeeper-install: ../deps/zookeeper/src/zookeeper-stamp/zookeeper-build
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/root/PowerGraph/debug/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Performing install step for 'zookeeper'"
...
../deps/zookeeper/src/zookeeper-stamp/zookeeper-mkdir:
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/root/PowerGraph/debug/CMakeFiles --progress-num=$(CMAKE_PROGRESS_3) "Creating directories for 'zookeeper'"
...
../deps/zookeeper/src/zookeeper-stamp/zookeeper-download: ../deps/zookeeper/src/zookeeper-stamp/zookeeper-mkdir
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/root/PowerGraph/debug/CMakeFiles --progress-num=$(CMAKE_PROGRESS_4) "Performing download step (download, verify and extract) for 'zookeeper'"
...
../deps/zookeeper/src/zookeeper-stamp/zookeeper-update: ../deps/zookeeper/src/zookeeper-stamp/zookeeper-download
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/root/PowerGraph/debug/CMakeFiles --progress-num=$(CMAKE_PROGRESS_5) "No update step for 'zookeeper'"
...
../deps/zookeeper/src/zookeeper-stamp/zookeeper-patch: ../deps/zookeeper/src/zookeeper-stamp/zookeeper-download
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/root/PowerGraph/debug/CMakeFiles --progress-num=$(CMAKE_PROGRESS_6) "Performing patch step for 'zookeeper'"
...
../deps/zookeeper/src/zookeeper-stamp/zookeeper-configure: ../deps/zookeeper/src/zookeeper-stamp/zookeeper-patch
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/root/PowerGraph/debug/CMakeFiles --progress-num=$(CMAKE_PROGRESS_7) "Performing configure step for 'zookeeper'"
...
../deps/zookeeper/src/zookeeper-stamp/zookeeper-build: ../deps/zookeeper/src/zookeeper-stamp/zookeeper-configure
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/root/PowerGraph/debug/CMakeFiles --progress-num=$(CMAKE_PROGRESS_8) "Performing build step for 'zookeeper'"
...
CMakeFiles/zookeeper.dir/depend:
	cd /root/PowerGraph/debug && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /root/PowerGraph /root/PowerGraph /root/PowerGraph/debug /root/PowerGraph/debug /root/PowerGraph/debug/CMakeFiles/zookeeper.dir/DependInfo.cmake --color=$(COLOR)
