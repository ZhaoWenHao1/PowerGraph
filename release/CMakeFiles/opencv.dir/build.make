...
CMakeFiles/opencv-complete: ../deps/opencv/src/opencv-stamp/opencv-install
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/root/PowerGraph/release/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Completed 'opencv'"
	/usr/local/bin/cmake -E make_directory /root/PowerGraph/release/CMakeFiles
	/usr/local/bin/cmake -E touch /root/PowerGraph/release/CMakeFiles/opencv-complete
...
../deps/opencv/src/opencv-stamp/opencv-install: ../deps/opencv/src/opencv-stamp/opencv-build
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/root/PowerGraph/release/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Performing install step for 'opencv'"
...
../deps/opencv/src/opencv-stamp/opencv-mkdir:
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/root/PowerGraph/release/CMakeFiles --progress-num=$(CMAKE_PROGRESS_3) "Creating directories for 'opencv'"
...
../deps/opencv/src/opencv-stamp/opencv-download: ../deps/opencv/src/opencv-stamp/opencv-mkdir
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/root/PowerGraph/release/CMakeFiles --progress-num=$(CMAKE_PROGRESS_4) "Performing download step (download, verify and extract) for 'opencv'"
...
../deps/opencv/src/opencv-stamp/opencv-update: ../deps/opencv/src/opencv-stamp/opencv-download
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/root/PowerGraph/release/CMakeFiles --progress-num=$(CMAKE_PROGRESS_5) "No update step for 'opencv'"
...
../deps/opencv/src/opencv-stamp/opencv-patch: ../deps/opencv/src/opencv-stamp/opencv-download
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/root/PowerGraph/release/CMakeFiles --progress-num=$(CMAKE_PROGRESS_6) "Performing patch step for 'opencv'"
...
../deps/opencv/src/opencv-stamp/opencv-configure: ../deps/opencv/src/opencv-stamp/opencv-patch
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/root/PowerGraph/release/CMakeFiles --progress-num=$(CMAKE_PROGRESS_7) "Performing configure step for 'opencv'"
...
../deps/opencv/src/opencv-stamp/opencv-build: ../deps/opencv/src/opencv-stamp/opencv-configure
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/root/PowerGraph/release/CMakeFiles --progress-num=$(CMAKE_PROGRESS_8) "Performing build step for 'opencv'"
...
CMakeFiles/opencv.dir/depend:
	cd /root/PowerGraph/release && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /root/PowerGraph /root/PowerGraph /root/PowerGraph/release /root/PowerGraph/release /root/PowerGraph/release/CMakeFiles/opencv.dir/DependInfo.cmake --color=$(COLOR)
