...
tests/CMakeFiles/distributed_chandy_misra_test.dir/distributed_chandy_misra_test.cpp.o: ../tests/distributed_chandy_misra_test.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/root/PowerGraph/release/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object tests/CMakeFiles/distributed_chandy_misra_test.dir/distributed_chandy_misra_test.cpp.o"
	cd /root/PowerGraph/release/tests && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/distributed_chandy_misra_test.dir/distributed_chandy_misra_test.cpp.o -c /root/PowerGraph/tests/distributed_chandy_misra_test.cpp
...
tests/CMakeFiles/distributed_chandy_misra_test.dir/distributed_chandy_misra_test.cpp.i: cmake_force
	...
	cd /root/PowerGraph/release/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /root/PowerGraph/tests/distributed_chandy_misra_test.cpp > CMakeFiles/distributed_chandy_misra_test.dir/distributed_chandy_misra_test.cpp.i
...
tests/CMakeFiles/distributed_chandy_misra_test.dir/distributed_chandy_misra_test.cpp.s: cmake_force
	...
	cd /root/PowerGraph/release/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /root/PowerGraph/tests/distributed_chandy_misra_test.cpp -o CMakeFiles/distributed_chandy_misra_test.dir/distributed_chandy_misra_test.cpp.s
...
tests/distributed_chandy_misra_test: /usr/lib/jvm/default-java/lib/server/libjvm.so
tests/distributed_chandy_misra_test: ../deps/local/lib/libboost_filesystem.a
tests/distributed_chandy_misra_test: ../deps/local/lib/libboost_program_options.a
tests/distributed_chandy_misra_test: ../deps/local/lib/libboost_system.a
tests/distributed_chandy_misra_test: ../deps/local/lib/libboost_iostreams.a
...
tests/distributed_chandy_misra_test: tests/CMakeFiles/distributed_chandy_misra_test.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/root/PowerGraph/release/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable distributed_chandy_misra_test"
	cd /root/PowerGraph/release/tests && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/distributed_chandy_misra_test.dir/link.txt --verbose=$(VERBOSE)
...
tests/CMakeFiles/distributed_chandy_misra_test.dir/clean:
	cd /root/PowerGraph/release/tests && $(CMAKE_COMMAND) -P CMakeFiles/distributed_chandy_misra_test.dir/cmake_clean.cmake
.PHONY : tests/CMakeFiles/distributed_chandy_misra_test.dir/clean

tests/CMakeFiles/distributed_chandy_misra_test.dir/depend:
	cd /root/PowerGraph/release && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /root/PowerGraph /root/PowerGraph/tests /root/PowerGraph/release /root/PowerGraph/release/tests /root/PowerGraph/release/tests/CMakeFiles/distributed_chandy_misra_test.dir/DependInfo.cmake --color=$(COLOR)
