...
tests/lock_free_pushback.cxx.cpp: ../tests/lock_free_pushback.cxx
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/root/PowerGraph/release/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating lock_free_pushback.cxx.cpp"
	cd /root/PowerGraph/tests && /usr/bin/python /root/PowerGraph/cxxtest/cxxtestgen --runner=ErrorPrinter -o /root/PowerGraph/release/tests/lock_free_pushback.cxx.cpp lock_free_pushback.cxx
...
tests/CMakeFiles/lock_free_pushback.cxxtest.dir/lock_free_pushback.cxx.cpp.o: tests/lock_free_pushback.cxx.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/root/PowerGraph/release/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Building CXX object tests/CMakeFiles/lock_free_pushback.cxxtest.dir/lock_free_pushback.cxx.cpp.o"
	cd /root/PowerGraph/release/tests && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -I/root/PowerGraph/tests -o CMakeFiles/lock_free_pushback.cxxtest.dir/lock_free_pushback.cxx.cpp.o -c /root/PowerGraph/release/tests/lock_free_pushback.cxx.cpp
...
tests/CMakeFiles/lock_free_pushback.cxxtest.dir/lock_free_pushback.cxx.cpp.i: cmake_force
	...
	cd /root/PowerGraph/release/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -I/root/PowerGraph/tests -E /root/PowerGraph/release/tests/lock_free_pushback.cxx.cpp > CMakeFiles/lock_free_pushback.cxxtest.dir/lock_free_pushback.cxx.cpp.i
...
tests/CMakeFiles/lock_free_pushback.cxxtest.dir/lock_free_pushback.cxx.cpp.s: cmake_force
	...
	cd /root/PowerGraph/release/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -I/root/PowerGraph/tests -S /root/PowerGraph/release/tests/lock_free_pushback.cxx.cpp -o CMakeFiles/lock_free_pushback.cxxtest.dir/lock_free_pushback.cxx.cpp.s
...
tests/lock_free_pushback.cxxtest: /usr/lib/jvm/default-java/lib/server/libjvm.so
tests/lock_free_pushback.cxxtest: ../deps/local/lib/libboost_filesystem.a
tests/lock_free_pushback.cxxtest: ../deps/local/lib/libboost_program_options.a
tests/lock_free_pushback.cxxtest: ../deps/local/lib/libboost_system.a
tests/lock_free_pushback.cxxtest: ../deps/local/lib/libboost_iostreams.a
...
tests/lock_free_pushback.cxxtest: tests/CMakeFiles/lock_free_pushback.cxxtest.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/root/PowerGraph/release/CMakeFiles --progress-num=$(CMAKE_PROGRESS_3) "Linking CXX executable lock_free_pushback.cxxtest"
	cd /root/PowerGraph/release/tests && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/lock_free_pushback.cxxtest.dir/link.txt --verbose=$(VERBOSE)
...
tests/CMakeFiles/lock_free_pushback.cxxtest.dir/clean:
	cd /root/PowerGraph/release/tests && $(CMAKE_COMMAND) -P CMakeFiles/lock_free_pushback.cxxtest.dir/cmake_clean.cmake
...
tests/CMakeFiles/lock_free_pushback.cxxtest.dir/depend: tests/lock_free_pushback.cxx.cpp
	cd /root/PowerGraph/release && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /root/PowerGraph /root/PowerGraph/tests /root/PowerGraph/release /root/PowerGraph/release/tests /root/PowerGraph/release/tests/CMakeFiles/lock_free_pushback.cxxtest.dir/DependInfo.cmake --color=$(COLOR)
